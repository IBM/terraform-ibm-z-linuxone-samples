...
- The Ansible stage was initially run as a `local_exec` in the HAProxy instance resource module, then as part of a `null_resource` at the top level (you can still see this code commented-out).
...
Credit to **Simon Lynch** of Hashicorp for the initial test work that started this off, and for hints and tips along the way!
